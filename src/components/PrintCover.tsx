...
export function PrintCover({ student }: { student: Student }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center space-y-12">
      ...
      <div>
        <h1 className="text-3xl font-bold tracking-widest mt-2">RAPOR PESERTA DIDIK</h1>
        <h2 className="text-2xl font-bold mt-2">SEKOLAH MENENGAH KEJURUAN<br/>(SMK)<br/>{schoolInfo.name}</h2>
      </div>

      <div className="text-left w-2/3 mt-2 text-lg">
      ...
      <div className="text-center w-2/3 mt-2">
        ...
        <p className="text-lg mt-2">NIS/NISN</p>
